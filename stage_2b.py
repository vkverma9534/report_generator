def run():
    ...
    # 🔍 Print existing tables to ensure INVENTORY, SALES, RETURNS are present
    print("Tables in DB:", cur.execute("SELECT name FROM sqlite_master WHERE type='table';").fetchall())
